...
const easyMDE = new EasyMDE({
    ...
    autosave: { // Optional: Speichert den Inhalt im LocalStorage
        enabled: true,
        delay: 1000,
...
projectSearch.addEventListener("change", () => {
    ...
    selectedProjectId = selectedOption ? projects.find(p => (p.name_with_namespace || p.name) === selectedOption.value)?.id : null;
});
